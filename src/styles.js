const styles = {
  ...
  heroSubText:
    "text-gray-800 dark:text-[#dfd9ff] font-medium lg:text-[30px] sm:text-[26px] xs:text-[20px] text-[16px] lg:leading-[40px]",

  sectionHeadText:
    "text-gray-900 dark:text-white font-black md:text-[60px] sm:text-[50px] xs:text-[40px] text-[30px]",
  sectionSubText:
    "text-gray-700 dark:text-gray-400 sm:text-[18px] text-[14px] uppercase tracking-wider",
};
