...
const App = () => {
  ...
  return (
    <BrowserRouter>
      <div className='relative z-0 bg-white dark:bg-primary text-black dark:text-white'>
        <div className='bg-hero-pattern bg-cover bg-no-repeat bg-center dark:bg-hero-pattern'>
          <Navbar />
          <Hero />
        </div>
        <About />
